...
from .validators.validators import ForbiddenWordValidator, RepeatAnnouncementValidator, price_zero_validator
...
class AnnouncementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Announcement
        fields = ('id', 'title', 'price', 'description', 'image', 'created_at', 'owner', 'average_rating')
        validators = [
