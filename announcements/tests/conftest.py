...
def announcement_fixture(user_is_owner_fixture):
    ...
    announcement = Announcement.objects.create(title="test title", price=100, owner=user_is_owner_fixture)
    return announcement
...
def review_fixture(user_is_owner_fixture, announcement_fixture):
    ...
    return Review.objects.create(text="test text", owner=user_is_owner_fixture, announcement=announcement_fixture, rating=5)
